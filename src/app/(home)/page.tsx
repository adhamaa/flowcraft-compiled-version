...
async function HomePage({
  searchParams: { cycle_id, selected_app, process_stage_uuid }
}: {
  searchParams: { cycle_id: string; selected_app: string; process_stage_uuid: string; }
}) {
