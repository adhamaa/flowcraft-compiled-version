...
const WithEntryNode = ({ data: { label }, selected }: NodeProps) => {
  return (
    <div className={clsx('flex flex-col items-center w-60', selected && 'border border-dashed border-[var(--fc-brand-700)]')}>
...
export default React.memo(WithEntryNode);